...
# Emergency shuttle
emergency-shuttle-left = The Evacuation Vessel has lifted off. {$transitTime} seconds to arrival.
emergency-shuttle-launch-time = The Evacuation Vessel will launch in {$consoleAccumulator} seconds.
emergency-shuttle-docked = The Evacuation Vessel has docked {$direction} of the station, {$location}. It will leave in {$time} seconds.
